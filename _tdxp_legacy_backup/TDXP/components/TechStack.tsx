    ...
    return (
        <section id="stack" className="scroll-mt-24 overflow-hidden bg-secondary py-20 text-white md:py-28">
            <div className="mx-auto max-w-7xl px-4 md:px-8">
                ...
                {/* Marquee logo vô tận */}
                <div className="pause-on-hover relative mt-14 overflow-hidden border-t border-white/10 pt-10">
                    ...
                    <div className="animate-marquee flex w-max items-center gap-12 text-white/40">
                        {[...technologies, ...technologies].map((tech, idx) => (
                            <span key={`${tech.id}-${idx}`} className="transition-colors hover:text-white">
                                <TechLogo logo={tech.logo} name={tech.name} />
                            </span>
                        ))}
                    </div>
