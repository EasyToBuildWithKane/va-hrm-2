        ...
        <section id="roadmap" className="scroll-mt-24 py-20 md:py-28" ref={ref}>
            <div className="mx-auto max-w-3xl px-4 md:px-8">
                <div className="mb-12 text-center">
                    ...
                    <h2 className="mt-3 text-3xl font-bold text-white md:text-4xl">Lộ trình phát triển</h2>
                    <p className="mt-3 text-white/70">Hành trình từ chuyển đổi số đến doanh nghiệp ưu tiên AI.</p>
                </div>
                <div className="relative">
                    ...
                    <ul className="space-y-12">
                        {roadmapItems.map((item, i) => (
                            ...
                            >
                                <span
                                    className={`absolute top-2 h-3 w-3 rounded-full bg-primary ring-4 ring-surface md:top-3 ${
